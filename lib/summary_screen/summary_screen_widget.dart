                  ...
                  child: PagedListView<DocumentSnapshot<Object>, CallsRecord>(
                        ...
                        queryCallsRecordPage(
                          ...
                          final streamSubscription =
                            ...
                            final itemIndexes = _pagingController.itemList
                                .asMap()
                                .map((k, v) => MapEntry(v.docid, k));
                            data.forEach((item) {
                              final index = itemIndexes[item.docid];
                              ...
                              if (index != null) {
                                ...
                                _pagingController.itemList = {
                                  for (var item in items) item.docid: item
                                }.values.toList();
                              }
                            });
                            setState(() {});
                    ...
                    builderDelegate: PagedChildBuilderDelegate<CallsRecord>(
                      ...
                      noItemsFoundIndicatorBuilder: (_) => Center(
                        child: Text(FFLocalizations.of(context).getText("no_summary")),
                      ),
