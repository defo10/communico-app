...
import 'calls_record.dart';
import 'online_pool_record.dart';
import 'user_ratings_record.dart';
import 'mediator_ratings_record.dart';
...
class DocumentReferenceSerializer
  ...
  DocumentReference deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType: FullType.unspecified}) {
    if (serialized.runtimeType == String) return FirebaseFirestore.instance.doc(serialized);
...
class DateTimeSerializer implements PrimitiveSerializer<DateTime> {
  ...
  /// TODO: this workaround is necessary as without, for TokensRecord DateTimes,
  /// a timestamp is passed to this function, but for the UserRecords DateTime
  /// it is correctly parsed as DateTime
  @override
  DateTime deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType: FullType.unspecified}) {
    if (serialized.runtimeType == Timestamp) return (serialized as Timestamp).toDate();
    if (serialized.runtimeType == String) return DateTime.parse(serialized);
