...
import 'schema/online_pool_record.dart';
import 'schema/user_ratings_record.dart';
import 'schema/mediator_ratings_record.dart';
...
export 'schema/online_pool_record.dart';
export 'schema/user_ratings_record.dart';
export 'schema/mediator_ratings_record.dart';
...
/// Functions to query OnlinePoolRecords (as a Stream and as a Future).
Stream<List<OnlinePoolRecord>> queryOnlinePoolRecord({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      OnlinePoolRecord.collection,
...
Future<List<OnlinePoolRecord>> queryOnlinePoolRecordOnce({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<OnlinePoolRecord>> queryOnlinePoolRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
...
/// Functions to query MediatorRatingsRecords (as a Stream and as a Future).
Stream<List<MediatorRatingsRecord>> queryMediatorRatingsRecord({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MediatorRatingsRecord.collection,
...
Future<List<MediatorRatingsRecord>> queryMediatorRatingsRecordOnce({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<MediatorRatingsRecord>> queryMediatorRatingsRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
